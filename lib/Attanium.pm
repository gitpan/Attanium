...
The skeleton app generated by L<attanium-starter.pl> generates a base class rather than runnable module.  This is 
differen than the artifacts generated by titanium-starter.pl.  attanium-starter also generates a default 
...
Finally Attanium aims to be as compatible as possible with L<Catalyst> which also has the plugins which were 
added to Titanium to form Attanium.
